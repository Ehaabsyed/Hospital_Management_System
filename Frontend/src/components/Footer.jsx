...
function Footer() {
  return (
    <div className='border-t-2 z-10 footer border-black h-30 flex justify-around items-center text-xs'>
        <div className="logo flex justify-center items-center"><img src="/logo.png" className='h-25 w-28' alt="" /></div>
        <div className="footer-links">
            <ul className='flex justify-center items-center flex-col text-[16px]'>
        ...
        <div className="author flex flex-col text-[15px] text-blue-700">
